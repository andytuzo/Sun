...
// in simulator we redefine to format for ConectaMexico Developer console
...
{\
	NSString * exceptionName = [@"org.conectamexico." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.conectamexico";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIConectaMexicoNativeItemNone = -1, 
	UIConectaMexicoNativeItemSpinner = -2,
	UIConectaMexicoNativeItemProgressBar = -3,
	
	UIConectaMexicoNativeItemSlider = -4,
	UIConectaMexicoNativeItemSwitch = -5,
	UIConectaMexicoNativeItemMultiButton = -6,
	UIConectaMexicoNativeItemSegmented = -7,
	
	UIConectaMexicoNativeItemTextView = -8,
	UIConectaMexicoNativeItemTextField = -9,
	UIConectaMexicoNativeItemSearchBar = -10,
	
	UIConectaMexicoNativeItemPicker = -11,
	UIConectaMexicoNativeItemDatePicker = -12,
	
	UIConectaMexicoNativeItemInfoLight = -13,
	UIConectaMexicoNativeItemInfoDark = -14,
	
	UIConectaMexicoNativeItemDisclosure = -15,
	
	UIConectaMexicoNativeItemContactAdd = -16
};
